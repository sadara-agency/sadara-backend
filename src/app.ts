...
import matchEventTagRoutes from "@modules/matchEventTags/matchEventTag.routes";
...
import profileChangeRequestRoutes from "@modules/profileChangeRequests/profileChangeRequest.routes";
...
import executiveReportRoutes from "@modules/executive-report/executive-report.routes";
...
import supplementRoutes from "@modules/wellness/supplement.routes";
import postureAssessmentRoutes from "@modules/wellness/postureAssessment.routes";
import rehabProtocolRoutes from "@modules/wellness/rehabProtocol.routes";
...
import playerInboxRoutes from "@modules/player-inbox/playerInbox.routes";
import playerStatsRoutes from "@modules/playerStats/playerStats.routes";
...
app.use("/api/v1/matches", matchEventTagRoutes);
...
app.use("/api/v1/executive-reports", executiveReportRoutes);
...
app.use("/api/v1/posture-assessments", postureAssessmentRoutes);
app.use("/api/v1/rehab-protocols", rehabProtocolRoutes);
...
app.use("/api/v1/player-inbox", playerInboxRoutes);
