...
router.post('/bulk-delete', authorize('Admin'), asyncHandler(clubController.bulkRemove));
...
// ── Logo Upload ──
router.post('/:id/logo', authorize('Admin', 'Manager'), uploadSingle, verifyFileType, asyncHandler(clubController.uploadLogo));
