...
export const createPlayerSchema = z.object({
  ...
  playerType: z.enum(["Pro", "Amateur"]).default("Pro"),
  playerPackage: z.enum(["A+", "A", "B+", "B"]).default("B"),
  contractType: z.enum(["Professional", "Amateur"]).default("Professional"),
...
export const playerQuerySchema = z.object({
  ...
  playerType: z.enum(["Pro", "Amateur"]).optional(),
  playerPackage: z.enum(["A+", "A", "B+", "B"]).optional(),
  contractType: z.enum(["Professional", "Amateur"]).optional(),
