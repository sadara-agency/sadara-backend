...
export async function create(req: AuthRequest, res: Response) {
  const clearance = await clearanceService.createClearance(
    req.body,
    req.user!.id,
  );
...
export async function update(req: AuthRequest, res: Response) {
  const clearance = await clearanceService.updateClearance(
    req.params.id,
    req.body,
  );
...
export async function complete(req: AuthRequest, res: Response) {
  const clearance = await clearanceService.completeClearance(
    req.params.id,
    req.body,
  );
...
export async function getByContract(req: AuthRequest, res: Response) {
  const clearances = await clearanceService.getClearancesByContract(
