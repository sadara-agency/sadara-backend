...
router.get('/', (0, validate_1.validate)(player_schema_1.playerQuerySchema, 'query'), (0, errorHandler_1.asyncHandler)(playerController.list));
router.get('/:id', (0, errorHandler_1.asyncHandler)(playerController.getById));
